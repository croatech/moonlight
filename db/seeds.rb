...
# EQUIPMENT
  ...
  ## ITEMS
    ...
    Equipment::Item.create! [{name: 'Rag belt',          category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 5,  hp: 10,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/rag_belt.png")},
                             {name: 'Warm belt',         category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 15, hp: 30,  required_level: 2,  price: 100, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/warm_belt.png")},
                             {name: 'Motley belt',       category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 20, hp: 40,  required_level: 3,  price: 150, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/motley_belt.png")},
                             {name: 'Spiked belt',       category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 25, hp: 50,  required_level: 4,  price: 200, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/spiked_belt.png")},
                             {name: 'Ancient belt',      category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 30, hp: 60,  required_level: 5,  price: 250, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/ancient_belt.png")},
                             {name: 'Belt of Executor',  category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 35, hp: 70,  required_level: 6,  price: 300, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/belt_of_executor.png")},
                             {name: 'Spiked belt',       category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 40, hp: 80,  required_level: 7,  price: 350, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/spiked_belt.png")},
                             {name: 'Holy belt',         category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 45, hp: 90,  required_level: 8,  price: 400, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/holy_belt.png")},
                             {name: 'Titan belt',        category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 50, hp: 100, required_level: 9,  price: 450, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/titan_belt.png")},
                             {name: 'Kvark belt',        category_id: Equipment::Category.find_by(slug: 'belt').id, attack: 0, defense: 55, hp: 110, required_level: 10, price: 500, image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/kvark_belt.png")}]
    ### WEAPON
    Equipment::Item.create! [{name: 'Metal axe',       category_id: Equipment::Category.find_by(slug: 'weapon').id, attack: 11,  defense: 0, hp: 0,     required_level: 1,  price: 50,     image: File.new("#{Rails.root}/db/seeds/equipment/items/weapon/metal_axe.png")},
                             ...
                             {name: 'Axe of Croaton',  category_id: Equipment::Category.find_by(slug: 'weapon').id, attack: 666, defense: 100, hp: 100, required_level: 1,  price: 500000, image: File.new("#{Rails.root}/db/seeds/equipment/items/weapon/art/axe_of_croaton.png"), artifact: true}]
    ### SHIELD
    Equipment::Item.create! [{name: 'Wood shield',        category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 20,  hp: 30,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/wood_shield.png")},
                             {name: 'Blueberry shield',   category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 30,  hp: 40,  required_level: 2,  price: 100, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/blueberry_shield.png")},
                             {name: 'Spartan shield',     category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 40,  hp: 50,  required_level: 3,  price: 150, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/spartan_shield.png")},
                             {name: 'Duke shield',        category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 50,  hp: 60,  required_level: 4,  price: 200, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/duke_shield.png")},
                             {name: 'Bright shield',      category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 60,  hp: 70,  required_level: 5,  price: 250, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/bright_shield.png")},
                             {name: 'Spiked shield',      category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 70,  hp: 80,  required_level: 6,  price: 300, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/spiked_shield.png")},
                             {name: 'Round shield',       category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 80,  hp: 90,  required_level: 7,  price: 350, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/round_shield.png")},
                             {name: 'Gnoll shield',       category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 90,  hp: 100, required_level: 8,  price: 400, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/gnoll_shield.png")},
                             {name: 'Shield of executor', category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 100, hp: 110, required_level: 9,  price: 450, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/shield_of_executor.png")},
                             {name: 'Griever shield',     category_id: Equipment::Category.find_by(slug: 'shield').id, attack: 0, defense: 110, hp: 120, required_level: 10, price: 500, image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/griever_shield.png")}]
    ### RING
    Equipment::Item.create! [{name: 'Wood ring',    category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 0,  defense: 5,  hp: 10,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/wood_ring.png")},
                             {name: 'Ugly ring',    category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 2,  defense: 15, hp: 30,  required_level: 2,  price: 100, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/ugly_ring.png")},
                             {name: 'Lucky ring',   category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 4,  defense: 20, hp: 40,  required_level: 3,  price: 150, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/lucky_ring.png")},
                             {name: 'Sphere ring',  category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 6,  defense: 25, hp: 50,  required_level: 4,  price: 200, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/sphere_ring.png")},
                             {name: 'Magic ring',   category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 8,  defense: 30, hp: 60,  required_level: 5,  price: 250, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/magic_ring.png")},
                             {name: 'Ancient ring', category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 10, defense: 35, hp: 70,  required_level: 6,  price: 300, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/ancient_ring.png")},
                             {name: 'Elf ring',     category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 12, defense: 40, hp: 80,  required_level: 7,  price: 350, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/elf_ring.png")},
                             {name: 'Holy ring',    category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 14, defense: 45, hp: 90,  required_level: 8,  price: 400, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/holy_ring.png")},
                             {name: 'Titan ring',   category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 16, defense: 50, hp: 100, required_level: 9,  price: 450, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/titan_ring.png")},
                             {name: 'Kvark ring',   category_id: Equipment::Category.find_by(slug: 'ring').id, attack: 18, defense: 55, hp: 110, required_level: 10, price: 500, image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/kvark_ring.png")}]
    ### NECKLACE
    Equipment::Item.create! [{name: 'Bone amulet',      category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 5,  hp: 10,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/bone_amulet.png")},
                             {name: 'Stone amulet',     category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 5,  hp: 10,  required_level: 2,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/stone_amulet.png")},
                             {name: 'Emerald amulet',   category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 15, hp: 30,  required_level: 3,  price: 100, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/emerald_amulet.png")},
                             {name: 'Satanic amulet',   category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 20, hp: 40,  required_level: 4,  price: 150, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/satanic_amulet.png")},
                             {name: 'Ancient necklace', category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 30, hp: 60,  required_level: 5,  price: 250, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/ancient_amulet.png")},
                             {name: 'Sunny amulet',     category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 35, hp: 70,  required_level: 6,  price: 300, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/sunny_amulet.png")},
                             {name: 'Spiked amulet',    category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 40, hp: 80,  required_level: 7,  price: 350, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/spiked_amulet.png")},
                             {name: 'Weird amulet',     category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 45, hp: 90,  required_level: 8,  price: 400, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/weird_amulet.png")},
                             {name: 'Round amulet',     category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 50, hp: 100, required_level: 9,  price: 450, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/round_amulet.png")},
                             {name: 'Draenei amulet',   category_id: Equipment::Category.find_by(slug: 'necklace').id, attack: 0, defense: 55, hp: 110, required_level: 10, price: 500, image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/draenei_amulet.png")}]
    ...
    Equipment::Item.create! [{name: 'Tramp cloak',     category_id: Equipment::Category.find_by(slug: 'cloak').id, attack: 0,  defense: 5,  hp: 10,   required_level: 1,  price: 50,    image: File.new("#{Rails.root}/db/seeds/equipment/items/cloak/tramp_cloak.png")},
                             ...
                             {name: 'Cape of Croaton', category_id: Equipment::Category.find_by(slug: 'cloak').id, attack: 20, defense: 80, hp: 500,  required_level: 1,  price: 50000, image: File.new("#{Rails.root}/db/seeds/equipment/items/cloak/art/cape_of_croaton.png"), artifact: true}]
    ### PANTS
