...
# EQUIPMENT
  ## CATEGORIES
    Equipment::Category.create! [{name: 'Helmet',   type: 'helmet'},
                                 {name: 'Armor',    type: 'armor'},
                                 {name: 'Mail',     type: 'mail'},
                                 {name: 'Gloves',   type: 'gloves'},
                                 {name: 'Bracers',  type: 'bracers'},
                                 {name: 'Foots',    type: 'foots'},
                                 {name: 'Belt',     type: 'belt'},
  ...
  ## NORMAL ITEMS
    ### HELMET
      Equipment::Item.create! [{name: 'Leather hat',      equipment_category_id: Equipment::Category.find_by(type: 'helmet').id, attack: 0, defense: 6,  hp: 6,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/leather_hat.png")},
    ...
    ### CHEST
      Equipment::Item.create! [{name: 'Leather armor',   equipment_category_id: Equipment::Category.find_by(type: 'armor').id, attack: 0, defense: 10, hp: 20,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/armor/leather_armor.png")},
    ...
    ### MAIL
      Equipment::Item.create! [{name: 'Fur Vest',       equipment_category_id: Equipment::Category.find_by(type: 'mail').id, attack: 0, defense: 10, hp: 20,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/mail/fur_vest.png")},
    ...
    ### GLOVES
      Equipment::Item.create! [{name: 'Leather gloves',  equipment_category_id: Equipment::Category.find_by(type: 'gloves').id, attack: 0,  defense: 10, hp: 20,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/gloves/leather_gloves.png")},
    ...
    ### BRACERS
      Equipment::Item.create! [{name: 'Leather bracers',     equipment_category_id: Equipment::Category.find_by(type: 'bracers').id, attack: 0,  defense: 5,  hp: 10, required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/bracers/leather_bracers.png")},
    ...
    ### FOOTS
      Equipment::Item.create! [{name: 'Leather boots',      equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 0,  defense: 5,  hp: 10, required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/leather_boots.png")},
                               {name: 'Straw shoes',        equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 3,  defense: 5,  hp: 15, required_level: 2,  price: 100, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/straw_shoes.png")},
                               {name: 'Magic boots',        equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 6,  defense: 11, hp: 20, required_level: 3,  price: 150, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/magic_boots.png")},
                               {name: 'Boots of Manticore', equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 9,  defense: 16, hp: 24, required_level: 4,  price: 200, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/boots_of_manticore.png")},
                               {name: 'Ancient boots',      equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 12, defense: 20, hp: 29, required_level: 5,  price: 250, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/ancient_boots.png")},
                               {name: 'Boots of Executor',  equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 15, defense: 27, hp: 35, required_level: 6,  price: 300, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/boots_of_executor.png")},
                               {name: 'Spiked boots',       equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 18, defense: 30, hp: 44, required_level: 7,  price: 350, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/spiked_boots.png")},
                               {name: 'Holy boots',         equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 21, defense: 34, hp: 51, required_level: 8,  price: 400, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/holy_boots.png")},
                               {name: 'Titan boots',        equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 24, defense: 39, hp: 55, required_level: 9,  price: 450, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/titan_boots.png")},
                               {name: 'Kvark boots',        equipment_category_id: Equipment::Category.find_by(type: 'foots').id, attack: 26, defense: 45, hp: 63, required_level: 10, price: 500, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/kvark_boots.png")}]
    ### BELT
      Equipment::Item.create! [{name: 'Rag belt',          equipment_category_id: Equipment::Category.find_by(type: 'belt').id, attack: 0, defense: 5,  hp: 10,  required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/belt/rag_belt.png")},
    ...
    ### WEAPON
      Equipment::Item.create! [{name: 'Metal axe',       equipment_category_id: Equipment::Category.find_by(type: 'weapon').id, attack: 11,  defense: 0, hp: 0, required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/weapon/metal_axe.png")},
    ...
    ### SHIELD
      Equipment::Item.create! [{name: 'Wood shield',        equipment_category_id: Equipment::Category.find_by(type: 'shield').id, attack: 0, defense: 20,  hp: 15, required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/shield/wood_shield.png")},
    ...
    ### RING
      Equipment::Item.create! [{name: 'Wood ring',    equipment_category_id: Equipment::Category.find_by(type: 'ring').id, attack: 0,  defense: 5,  hp: 10, required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/ring/wood_ring.png")},
    ...
    ### NECKLACE
      Equipment::Item.create! [{name: 'Bone amulet',      equipment_category_id: Equipment::Category.find_by(type: 'necklace').id, attack: 0, defense: 5,  hp: 10, required_level: 1,  price: 50,  image: File.new("#{Rails.root}/db/seeds/equipment/items/necklace/bone_amulet.png")},
    ...
    ### CLOAK
      Equipment::Item.create! [{name: 'Tramp cloak',     equipment_category_id: Equipment::Category.find_by(type: 'cloak').id, attack: 0,  defense: 5,  hp: 10,  required_level: 1,  price: 50,    image: File.new("#{Rails.root}/db/seeds/equipment/items/cloak/tramp_cloak.png")},
    ...
    ### PANTS
      Equipment::Item.create! [{name: 'Leather pants',    equipment_category_id: Equipment::Category.find_by(type: 'pants').id, attack: 0,  defense: 5,  hp: 5,    required_level: 1,  price: 50,   image: File.new("#{Rails.root}/db/seeds/equipment/items/pants/leather_pants.png")},
  ...
  ## ARTIFACTS
  ### SAPPHIRE SET
    Equipment::Item.create! [{name: 'Sapphire helm',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 70,  hp: 80,  required_level: 11,  price: 3000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/sapphire_helm.png"), artifact: true},
                             ...
                             {name: 'Sapphire boots',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 15,  defense: 65,  hp: 75,  required_level: 11,  price: 3000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/sapphire_boots.png"), artifact: true},
  ...
  ### BERSERKER SET
    Equipment::Item.create! [{name: 'Helm of Berserker',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 120, hp: 120, required_level: 12,  price: 5000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/helm_of_berserker.png"), artifact: true},
  ...
  ### MAD KNIGHT SET
    Equipment::Item.create! [{name: 'Helm of Mad Knight',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 125, hp: 140, required_level: 13,  price: 8000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/helm_of_mad_knight.png"), artifact: true},
                             ...
                             {name: 'Boots of Mad Knight',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 20,  defense: 95,  hp: 135, required_level: 13,  price: 8000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/boots_of_mad_knight.png"), artifact: true},
  ...
  ### BARBED SET
    Equipment::Item.create! [{name: 'Barbed helm',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 125, hp: 165, required_level: 14,  price: 12000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/barbed_helm.png"), artifact: true},
                             ...
                             {name: 'Barbed boots',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 25,  defense: 100, hp: 155, required_level: 14,  price: 12000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/barbed_boots.png"), artifact: true},
  ...
  ### MOON SET
    Equipment::Item.create! [{name: 'Moon helm',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 130, hp: 185, required_level: 15,  price: 15000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/moon_helm.png"), artifact: true},
                             ...
                             {name: 'Moon boots',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 25,  defense: 105, hp: 165, required_level: 15,  price: 15000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/moon_boots.png"), artifact: true},
  ...
  ### WINGED GOD SET
    Equipment::Item.create! [{name: 'Helm of Winged God',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 135, hp: 200, required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/helm_of_winged_god.png"), artifact: true},
                             ...
                             {name: 'Boots of Winged God',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 30,  defense: 110, hp: 180, required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/boots_of_winged_god.png"), artifact: true},
  ...
  ### AMBER PHOENIX SET
    Equipment::Item.create! [{name: 'Helm of Amber Phoenix',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 140, hp: 220, required_level: 17,  price: 19000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/helm_of_amber_phoenix.png"), artifact: true},
                             ...
                             {name: 'Boots of Amber Phoenix',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 35,  defense: 115, hp: 195, required_level: 17,  price: 19000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/boots_of_amber_phoenix.png"), artifact: true},
  ...
  ### AMETHYST SET
    Equipment::Item.create! [{name: 'Amethyst helm',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 140, hp: 240, required_level: 18,  price: 21000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/amethyst_helm.png"), artifact: true},
                             ...
                             {name: 'Amethyst boots',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 40,  defense: 125, hp: 215, required_level: 18,  price: 21000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/amethyst_boots.png"), artifact: true},
  ...
  ### DEMON WARRIOR SET
    Equipment::Item.create! [{name: 'Helm of Demon Warrior',    equipment_category_id: Equipment::Category.find_by(type: 'helmet').id,   attack: 0,   defense: 150, hp: 260, required_level: 19,  price: 23000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/helm_of_demon_warrior.png"), artifact: true},
                             ...
                             {name: 'Boots of Demon Warrior',   equipment_category_id: Equipment::Category.find_by(type: 'foots').id,    attack: 45,  defense: 135, hp: 230, required_level: 19,  price: 23000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/boots_of_demon_warrior.png"), artifact: true},
...
# TOOLS
  ## CATEGORIES
  Tool::Category.create! [{name: 'Lumberjacking', type: 'lumberjacking'},
                          {name: 'Fishing',       type: 'fishing'}]

  ## ITEMS
    ### LUMBERJACKING
    Tool::Item.create! [{id: 1, name: 'Axe for a beech',           tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 100,   required_skill: 0,   image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_a_beech.png")},
                        {id: 2, name: 'Axe for an elm',            tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 200,   required_skill: 50,  image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_an_elm.png")},
                        {id: 3, name: 'Axe for a larch',           tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 400,   required_skill: 100, image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_a_larch.png")},
                        {id: 4, name: 'Axe for a birch',           tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 800,   required_skill: 150, image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_a_birch.png")},
                        {id: 5, name: 'Axe for a sequoia',         tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 1600,  required_skill: 200, image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_a_sequoia.png")},
                        {id: 6, name: 'Axe for an eucalyptus',     tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 3200,  required_skill: 250, image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_an_eucalyptus.png")},
                        {id: 7, name: 'Axe for a rowan',           tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 6400,  required_skill: 300, image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_a_rowan.png")},
                        {id: 8, name: 'Axe for a mysterious wood', tool_category_id: Tool::Category.find_by(type: 'lumberjacking').id, price: 12800, required_skill: 350, image: File.new("#{Rails.root}/db/seeds/tools/items/lumberjacking/axe_for_a_mysterious_wood.png")}]
