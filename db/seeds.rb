...
# EQUIPMENT
  ...
  ### MOON SET
    Equipment::Item.create! [{name: 'Helm of Winged God',    category_id: Equipment::Category.find_by(slug: 'helmet').id,   attack: 0,   defense: 135, hp: 200, required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/helmet/art/helm_of_winged_god.png"), artifact: true},
                             ...
                             {name: 'Gloves of Winged God',  category_id: Equipment::Category.find_by(slug: 'gloves').id,   attack: 25,  defense: 110, hp: 180, required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/gloves/art/gloves_of_winged_god.png"), artifact: true},
                             {name: 'Bracers of Winged God', category_id: Equipment::Category.find_by(slug: 'bracers').id,  attack: 25,  defense: 110, hp: 180, required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/bracers/art/bracers_of_winged_god.png"), artifact: true},
                             {name: 'Boots of Winged God',   category_id: Equipment::Category.find_by(slug: 'foots').id,    attack: 25,  defense: 110, hp: 180, required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/foots/art/boots_of_winged_god.png"), artifact: true},
                             ...
                             {name: 'Aword of Winged God',   category_id: Equipment::Category.find_by(slug: 'weapon').id,   attack: 250, defense: 0,   hp: 0,   required_level: 16,  price: 17000, image: File.new("#{Rails.root}/db/seeds/equipment/items/weapon/art/sword_of_winged_god.png"), artifact: true},
