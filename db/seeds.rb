...
# EQUIPMENT
  ...
  ## ITEMS
    ...
    Equipment::Item.create! [{name: 'Leather pants',    category_id: Equipment::Category.find_by(slug: 'pants').id, attack: 0,  defense: 5,  hp: 5,    required_level: 1,  price: 50,   image: File.new("#{Rails.root}/db/seeds/equipment/items/pants/leather_pants.png")},
                             ...
                             {name: 'Spectral pants',   category_id: Equipment::Category.find_by(slug: 'pants').id, attack: 0,  defense: 100, hp: 100, required_level: 10, price: 5000, image: File.new("#{Rails.root}/db/seeds/equipment/items/pants/spectral_pants.png")},
